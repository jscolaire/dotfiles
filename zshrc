...
export PATH="/usr/local/bin:/usr/bin:/bin:/usr/local/games:/usr/games:/home/jcaro/.local/bin:/opt/android-studio/bin"
...
#
alias rw="sudo /usr/local/bin/reconnect-wifi"
alias t="~/.todo.txt_cli-2.10/todo.sh"
alias yl="youtube-dl"
